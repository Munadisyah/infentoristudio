...
// Ambil data admin sebelum proses update
$query = "SELECT * FROM user WHERE user_id='$user_id'";
$result = mysqli_query($koneksi, $query);
if (!$result) {
    echo '<script>alert("Gagal mengambil data: ' . mysqli_error($koneksi) . '"); window.location="admin_dashboard.php";</script>';
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $foto_profil = $admin['foto_profil'] ?? null;
            ...
            if (!is_writable($target_dir)) {
                ...
                if (!in_array($file_extension, $allowed_extensions)) {
                    ...
                    if (move_uploaded_file($_FILES["foto_profil"]["tmp_name"], $target_file)) {
                        ...
                        if ($admin['foto_profil'] && file_exists($admin['foto_profil'])) {
                            if (!unlink($admin['foto_profil'])) {
    ...
    if ($koneksi) {
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                echo '<script>alert("Profil berhasil diperbarui!"); window.location="admin_profil.php";</script>';
            } else {
        ...
        <div class="profile-container">
            ...
            <form method="POST" class="profile-form" enctype="multipart/form-data">
                ...
                <?php if ($admin['foto_profil']): ?>
                    <img src="<?php echo $admin['foto_profil']; ?>" alt="Foto Profil">
                <?php endif; ?>
                ...
                <input type="text" id="alamat" name="alamat" value="<?php echo $admin['alamat']; ?>" required>

                <label for="email">Email</label>
                <input type="email" id="email" name="email" value="<?php echo $admin['email']; ?>" required>

                <label for="no_telp">No. Telepon</label>
                <input type="text" id="no_telp" name="no_telp" value="<?php echo $admin['no_telp']; ?>" required>
